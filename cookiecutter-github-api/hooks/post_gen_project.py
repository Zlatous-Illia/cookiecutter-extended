...
def main():
    ...
    if git_integration != "none":
        ...
        if git_integration == "github":
            execute_command("pip install PyGithub", "Помилка при встановленні PyGithub")
            create_github_repo()
        elif git_integration == "gitlab":
            execute_command("pip install python-gitlab", "Помилка при встановленні python-gitlab")
            create_gitlab_repo()
